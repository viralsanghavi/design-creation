  ...
  return (
    <PageLayout>
      ...
      <section className="text-gray-600 body-font relative w-full">
        <div className="container w-full px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="w-full bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            ></iframe>
            <div className="bg-white relative flex flex-wrap p-8 rounded shadow-md">
              <div className="lg:w-1/2 px-6">
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">
                  ADDRESS
                </h2>
                <p className="mt-1">Design Creation</p>
              </div>
