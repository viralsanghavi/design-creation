...
const ScrollText = () => {
  ...
  const getWordStyle = (index) => {
    ...
    const color = useTransform(scrollY, [start, end], ["#000000", "#ff0000"]); // Black to Red

    return {color};
  };

  return (
    <div className="text-4xl p-10 flex flex-wrap gap-2 min-h-svh items-center justify-center sticky top-0">
